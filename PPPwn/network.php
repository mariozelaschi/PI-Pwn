                ...
                <tr>
                    <td>
                        <form method=\"post\">
                            ...
                            <br><br><br>
                            <center>
                                <button name=\"saveppp\" value=\"saveppp\">Save PPP</button>
                            </center>
                        </form>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <form method=\"post\">
                            ...
                            <label for=\"wifip\">WiFi Password</label>
                            <br>
                            <input type=\"checkbox\" onclick=\"showpw()\">
                            <label style=\"font-size:12px; padding:4px;\">Show Password</label>
                            <br><br><br>
                            <center>
                                <button name=\"savewifi\" value=\"savewifi\">Save WiFi</button>
                            </center>
                        </form>
                    </td>
                </tr>
